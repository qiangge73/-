...
def FindNode(root, pos):
    ...
    if isDone:
        return
    for items in root:
        if (items.data[0] == pos[0] and items.data[1] == pos[1] and items.data[2] == pos[2]):
            templb = MuxTree()
            templb.data[0] = pos[3]
            templb.data[1] = pos[4]
            templb.data[2] = pos[5]
            items.Child.append(templb)
            isDone = True
            return
        if (len(items.Child) > 0):
            FindNode(items.Child,pos)
            ...
            if(npZerodata[N0layer1][N0y][N0x]>=4):
                ...
                if N0layer1 == 0 or kkk:
                    if (npZerodata[N0layer1+1][N0y][N0x] >= 4):  #正上方
                        ...
                        isDone = False
                        datas = [N0layer1,N0y,N0x,N0layer1+1,N0y,N0x]
                        FindNode(RootNode,datas)
                        if not isDone:
                            templb = MuxTree()
                            templb.data[0] = datas[3]
                            templb.data[1] = datas[4]
                            templb.data[2] = datas[5]
                            RootNode.append(templb)
                        # lb-end
                    ...
                    if (npZerodata[N0layer1+1][(N0y-1 < 0 and  N0y or N0y-1)][(N0x-1 < 0 and  N0x or N0x-1)] >= 4):  #左下方
                        ...
                        isDone = False
                        datas = [N0layer1, N0y, N0x, N0layer1 + 1, N0y - 1 < 0 and N0y or N0y - 1, N0x-1 < 0 and  N0x or N0x-1]
                        FindNode(RootNode, datas)
                        if not isDone:
                            templb = MuxTree()
                            templb.data[0] = datas[3]
                    ...
                    if (npZerodata[N0layer1+1][(N0y-1 < 0 and  N0y or N0y-1)][N0x] >= 4):  #下方
                        ...
                        isDone = False
                        datas = [N0layer1, N0y, N0x, N0layer1 + 1, N0y-1 < 0 and  N0y or N0y-1, N0x]
                        FindNode(RootNode, datas)
                        if not isDone:
                            templb = MuxTree()
                            templb.data[0] = datas[3]
                    ...
                    if (npZerodata[N0layer1 + 1][(N0y - 1 < 0 and N0y or N0y - 1)][(N0x+1 > N0maxX and  N0x or N0x+1)] >= 4):  # 右下方
                        ...
                        isDone = False
                        datas = [N0layer1, N0y, N0x, N0layer1 + 1, N0y - 1 < 0 and N0y or N0y - 1, x+1 > N0maxX and  N0x or N0x+1]
                        FindNode(RootNode, datas)
                        if not isDone:
                            templb = MuxTree()
                            templb.data[0] = datas[3]
                    ...
                    if (npZerodata[N0layer1 + 1][N0y][(N0x -1 < 0 and N0x or N0x -1)] >= 4):  # 左方
                        ...
                        isDone = False
                        datas = [N0layer1, N0y, N0x, N0layer1 + 1, N0y, N0x -1 < 0 and N0x or N0x -1]
                        FindNode(RootNode, datas)
                        if not isDone:
                            templb = MuxTree()
                            templb.data[0] = datas[3]
                    ...
                    if (npZerodata[N0layer1 + 1][N0y][(N0x+1 > N0maxX and  N0x or N0x+1)] >= 4):  # 右方
                        ...
                        isDone = False
                        datas = [N0layer1, N0y, N0x, N0layer1 + 1, N0y, N0x+1 > N0maxX and  N0x or N0x+1]
                        FindNode(RootNode, datas)
                        if not isDone:
                            templb = MuxTree()
                            templb.data[0] = datas[3]
                    ...
                    if (npZerodata[N0layer1 + 1][(N0y+1 > N0maxY and  N0y or N0y+1)][(N0x -1 < 0 and N0x or N0x -1)] >= 4):  # 左上方
                        ...
                        isDone = False
                        datas = [N0layer1, N0y, N0x, N0layer1 + 1, N0y+1 > N0maxY and  N0y or N0y+1, N0x -1 < 0 and N0x or N0x -1]
                        FindNode(RootNode, datas)
                        if not isDone:
                            templb = MuxTree()
                            templb.data[0] = datas[3]
                    ...
                    if (npZerodata[N0layer1 + 1][(N0y+1 > N0maxY and  N0y or N0y+1)][N0x] >= 4):  # 上方
                        ...
                        isDone = False
                        datas = [N0layer1, N0y, N0x, N0layer1 + 1, N0y+1 > N0maxY and  N0y or N0y+1, N0x]
                        FindNode(RootNode, datas)
                        if not isDone:
                            templb = MuxTree()
                            templb.data[0] = datas[3]
                    ...
                    if (npZerodata[N0layer1 + 1][(N0y+1 > N0maxY and  N0y or N0y+1)][N0x+1 > N0maxX and  N0x or N0x+1] >= 4):  # 右上方
                        ...
                        isDone = False
                        datas = [N0layer1, N0y, N0x, N0layer1 + 1, N0y+1 > N0maxY and  N0y or N0y+1, N0x+1 > N0maxX and  N0x or N0x+1]
                        FindNode(RootNode, datas)
                        if not isDone:
                            templb = MuxTree()
                            templb.data[0] = datas[3]
...
# lb-start
D_end = open("data731.txt", "w")
nowRoot = MuxTree()
D_end.writelines("lb-data\n")

def outPrintFile(root):

    global nowRoot
    for item in root:
        if len(item.Child) == 0:
            D_end.writelines("(" + str(nowRoot.data[0])+","+ str(nowRoot.data[1])+","+ str(nowRoot.data[2])+")-("+item.data[0]+","+item.data[1]+","+item.data[2]+")\n")
            print("lb(" + str(nowRoot.data[0])+","+ str(nowRoot.data[1])+","+ str(nowRoot.data[2])+")-("+item.data[0]+","+item.data[1]+","+item.data[2]+")\n")
        else:
            outPrintFile(item.Child)

print("nihao"+str(len(RootNode)))
